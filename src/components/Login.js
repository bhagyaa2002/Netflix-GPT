...
const Login = () => {
  ...
  return (
   ...
   <form className="w-1/2 absolute p-12 bg-black my-36 mx-auto right-0 left-0 text-white bg-opacity-80">
    <h1 className='font-bold text-3xl py-4'>{isSignInForm? "Sign In":"Sign Up"}</h1>
    {!isSignInForm && <input type="Full Name" placeholder="Full Name" className="p-4 my-4 w-full bg-gray-600"/>}
     <br />
